 ...
 *         apresentada em letras maiúsculas (sem vírgula): se a entrada for “
 *         Guimaraes” , a saída deve ser “ GUIMARAES”; 
 *         
 *         se a última parte do nome
 *         for igual a "FILHO", "FILHA", "NETO", "NETA", "SOBRINHO", "SOBRINHA"
 *         ou "JUNIOR" e houver duas ou mais partes antes, a penúltima parte
 *         fará parte do sobrenome. 
 *         
 *         Assim: se a entrada for "Joao Silva Neto", a
 *         saída deve ser "SILVA NETO, Joao" ; se a entrada for "Joao Neto" , a
 *         saída deve ser "NETO, Joao"; as partes do nome que não fazem parte do
 *         sobrenome devem ser impressas com a inicial maiúscula e com as demais
 *         letras minúsculas; "da", "de", "do", "das", "dos" não fazem parte do
